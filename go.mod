...
require (
	...
	github.com/onflow/flow-go v0.41.0-rc.1.0.20250721195438-3107b6a7c189
...
require (
	...
	github.com/onflow/flow-core-contracts/lib/go/contracts v1.7.1 // indirect; v1.2.4-0.20230703193002-53362441b57d // indirect
