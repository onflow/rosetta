...
require (
	...
	github.com/onflow/flow-go v0.33.17
...
require (
	...
	github.com/onflow/flow-core-contracts/lib/go/contracts v1.2.4 // indirect
	github.com/onflow/flow-core-contracts/lib/go/templates v1.2.4 // indirect
